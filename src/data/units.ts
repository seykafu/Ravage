...
export const ENEMIES = {
  ...
  ravageTrooper: (id: string, seed: number, level = 19): UnitDef => ({
    ...
    classKind: "swordsman",
    weapon: "sword",
    stats: { hp: 42, power: 19, armor: 8, speed: 9, movement: 4, ap: 3 },
    statReferenceLevel: 19,
    artSeed: seed,
  ...
  ravageLancer: (id: string, seed: number, level = 19): UnitDef => ({
    ...
    classKind: "spearton",
    weapon: "spear",
    stats: { hp: 44, power: 19, armor: 9, speed: 8, movement: 4, ap: 3 },
    statReferenceLevel: 19,
    artSeed: seed,
    palette: ENEMY_PALETTES.ravage,
    tags: new Set(["elite"]),
  ...
  ravageMarksman: (id: string, seed: number, level = 19): UnitDef => ({
    ...
    classKind: "archer",
    weapon: "bow",
    stats: { hp: 30, power: 17, armor: 4, speed: 11, movement: 4, ap: 2 },
    statReferenceLevel: 19,
    artSeed: seed,
    palette: ENEMY_PALETTES.ravage,
    tags: new Set(["elite"]),
